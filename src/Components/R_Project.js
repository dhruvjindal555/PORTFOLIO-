...
function R_Project({ projectNo, heading, img, gitLink, deployedLink, desc }) {
    return (
        <div> <div className='flex flex-col sm:flex-row my-7 sm:my-10 justify-evenly items-center'>
            <div className='w-fit md:w-2/5 lg:w-1/3 flex flex-col justify-center mx-10'>
